...
🔹 AI-Powered Social Media Trend Analysis Dashboard
Led a 4-member team to build an end-to-end trend intelligence dashboard.
FastAPI · React.js · Tailwind CSS · Groq API (LLaMA 3.3 70B) · NewsAPI

🔹 AI News Brain (Hackathon Project)
A full-stack market intelligence app with a multi-agent architecture requiring zero external API keys.
FastAPI · Vanilla JS

🔹 Digital Health Record Management System
Designed a health record platform for migrant workers with an optional AI/ML layer.
React · Node.js · PostgreSQL · AWS

🔹 InsurAI — Insurance Claim Risk Prediction (Infosys Internship)
Full-stack Spring Boot application predicting insurance claim risk, integrating backend APIs with an ML model and a connected frontend.
Java · Spring Boot · ML Deployment
